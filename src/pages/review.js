// Review Page Custom Element
let templateContent = null;

async function loadTemplate() {
  if (!templateContent) {
    const template = await import('./review.html?raw');
...
class ReviewPage extends HTMLElement {
  ...
  async updateVersion(version) {
    ...
    // Add click handlers to all "Change" links
    this.querySelectorAll('goa-link').forEach(link => {
